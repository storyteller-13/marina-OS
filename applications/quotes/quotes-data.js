...
window.QUOTES = [
  ...
  { text: 'there is nothing outside of yourself that can ever enable you to get better, stronger, richer, or smarter. everything is within. seek nothing outside of yourself.', author: 'miyamoto musashi' },
    ...
    { text: 'all men are the same except for their belief in their own selves, regardless of what others may think of them.', author: 'miyamoto musashi' },
    { text: 'if you do not control the enemy, the enemy will control you.', author: 'miyamoto musashi' },
    { text: 'in battle, if you make your opponent flinch, you have already won.', author: 'miyamoto musashi' },
    { text: 'respect the gods, without relying on their help.', author: 'miyamoto musashi' },
    { text: 'if you know the way broadly you will see it in everything.', author: 'miyamoto musashi' },
    { text: 'the purpose of today\'s training is to defeat yesterday\'s understanding.', author: 'miyamoto musashi' },
    { text: 'do not waste time idling or thinking after you have set your goals.', author: 'miyamoto musashi' },
    { text: 'fixation is the way to death. fluidity is the way to life.', author: 'miyamoto musashi' },
    { text: 'the way is in training.', author: 'miyamoto musashi' },
    ...
    { text: 'know your enemy, know his sword.', author: 'miyamoto musashi' },
    { text: 'true warriors are fierce because their training is fierce.', author: 'miyamoto musashi' },
    { text: 'perceive that which cannot be seen with the eye.', author: 'miyamoto musashi' },
    { text: 'generally speaking, the way of the warrior is resolute acceptance of death.', author: 'miyamoto musashi' },
    { text: 'the path that leads to truth is littered with the bodies of the ignorant.', author: 'miyamoto musashi' },
    { text: 'develop intuitive judgement and understanding for everything.', author: 'miyamoto musashi' },
    { text: 'as far as i\'m concerned, i regret nothing.', author: 'miyamoto musashi' },
    { text: 'in time, all things work to your advantage when you pursue them with an open heart.', author: 'miyamoto musashi' },
    { text: 'see to it that you temper yourself with one thousand days of practice, and refine yourself with ten thousand days of training.', author: 'miyamoto musashi' },
