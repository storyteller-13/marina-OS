...
class MusicPlayerStorage {
    ...
    ensureDefaultPlaylists(data) {
        ...
        const legacyAfterlife = data.playlists.find(p => p.id === '2025 beyond afterlife');
        if (legacyAfterlife) {
            legacyAfterlife.id = '2026 beyond afterlife';
            legacyAfterlife.name = '2026 beyond afterlife';
        }
        if (data.currentPlaylistId === '2025 beyond afterlife') {
